        ...
        <Box color={"white"}>
            <Flex direction={"column"} gap="2rem">
                ...
                <Box>
                    ...
                    <Text mt="15px" textAlign={"justify"} fontFamily={"candara light"} fontSize={"17px"}>Hello, I’m Erick Carpes, an 19-year-old Software Engineering student with a passion for technology and a background in competitive sailing. My journey as an athlete since the age of 8 has instilled in me key qualities like discipline, resilience, and dedication: traits that I carry into my approach to software development. </Text> 
